...
(global-set-key [?\A-\M-r] '(lambda nil (interactive) (find-file "~/ac/acmacs/docs/template")))

(global-set-key [?\A-\M-w] '(lambda nil (interactive) (eu-compile-push-history "aw -h albertine aw-chain.py list-whocc")))
