...
(defun eu-compile-cd-pwd ()
  ...
  (let* ((dir (directory-file-name (file-name-directory (buffer-file-name))))
         ...
         (cmd (cond
               ...
               ((and (string-match "Makefile" basename) (string-match "/AD/" dirname)) (concat "make -w -C " dirname " -j8 -k T=D"))
               ((string-match "Makefile" basename) (concat "make -w -C " dirname " -j8 -k"))
               ((string-match "CMakeLists.txt" basename) (concat "make -w -C " dirname "/build -j8 -k"))
